...
import { UIDraggableBox2Component } from '@negocio/ui-components';
import { EnhancedBaseEditorSectionComponent } from '../enhanced-base-editor-section.component';

@Component({
  selector: 'lib-editor-draggable-box-2-section',
  standalone: true,
  imports: [
    CommonModule,
  ...
  template: `
    <div #sectionElement
      ...
      <div #componentElement class="editor-element"
           [class.is-selected]="selectedElementId === section.id + '_draggable-box-2'"
           (click)="selectElement($event, getMergedElement(section.id, section.id + '_draggable-box-2', section.content, 'draggable-box-2'))"
           [enhancedVisualEditable]="getComponentConfig()"
           elementId="{{section.id + '_draggable-box-2'}}"
           sectionId="{{section.id}}"
...
export class EditorDraggableBox2SectionComponent extends EnhancedBaseEditorSectionComponent implements AfterViewInit {
  @ViewChild('sectionElement', { static: true }) sectionElement!: ElementRef;
  @ViewChild('componentElement', { static: true }) componentElement!: ElementRef;

  ngAfterViewInit() {
    this.applySectionVisualEditing(this.sectionElement, this.section.id);
    this.applyElementVisualEditing(this.componentElement, this.section.id + '_draggable-box-2');
  }
  ...
  handleComponentEvent(event: VisualEditingEvent): void {
    this.handleVisualEvent(event, this.section.id + '_draggable-box-2');
  }
}
