...
@Component({
      ...
      <div class="isolated-mode-container" (click)="$event.stopPropagation()">
        ...
        <div class="isolated-mode-header">
          <div class="header-breadcrumb">
            ...
            <span class="component-name">CENTRO DE AYUDA PRO</span>
          </div>
        ...
        <div class="isolated-mode-body">
          <div class="controls-sidebar">
            <div class="sidebar-scroll-content">
                ...
                <div class="item-list">
                  <div *ngFor="let item of editableItems; let i = index" 
                    ...
                    <div class="item-main">
                      ...
                      <input type="text" [(ngModel)]="item.question" class="premium-input-mini" placeholder="Ej: ¿Qué incluye el servicio?">
                      <button (click)="removeItem(i, $event)" class="delete-btn">✕</button>
                    </div>
                    <div *ngIf="selectedIndex === i" class="item-details animate-fade-in">
                       <label>Respuesta</label>
                       <textarea [(ngModel)]="item.answer" class="premium-input-mini h-32 mt-1" placeholder="Escribe la respuesta aquí..."></textarea>
                    </div>
                  </div>
                </div>

                <button (click)="addItem()" class="add-btn-mini mt-4">+ Añadir Pregunta</button>
              </div>
              ...
              <div class="sidebar-section" *ngIf="activeTab === 'design'">
                <div class="section-header">
                  <span class="section-icon">🎨</span>
                  <h4>ESTILO Y PERSONALIZACIÓN</h4>
                </div>
                ...
                <div class="control-group">
                  ...
                  <select [(ngModel)]="editableContent.variant" class="premium-input">
                    ...
                    <option value="boxed">Cajas Separadas</option>
                    <option value="bordered">Borde Inferior</option>
                ...
                <div class="control-group">
                   <label class="checkbox-label">
                      <input type="checkbox" [(ngModel)]="editableContent.allowMultiple"> Permitir múltiples abiertas
                   </label>
                </div>

                <div class="control-group">
                   <label class="checkbox-label">
                      <input type="checkbox" [(ngModel)]="editableContent.showIcons"> Mostrar Iconos +/-
                   </label>
                </div>
              </div>
          ...
          <div class="isolated-canvas">
            ...
            <div class="modern-position-dock">
               <div class="dock-item"><span class="label">PREGUNTAS</span><span class="value text-indigo-400">{{ editableItems.length }}</span></div>
        ...
        <div class="isolated-mode-footer">
          <div class="footer-hint">FAQ Pro: Resuelve las dudas de tus clientes con un diseño profesional.</div>
  ...
  styles: [`
    ...
    .faq-item-card { background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 12px; cursor: pointer; transition: all 0.2s; }
    .faq-item-card:hover { border-color: rgba(255,255,255,0.1); background: rgba(255,255,255,0.05); }
    .faq-item-card.active { border-color: #10b981; background: rgba(16, 185, 129, 0.05); }
...
export class EditorFaqIsolatedModeComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    if (this.editableItems.length === 0) {
      this.editableItems = [
        { question: '¿Cómo funciona?', answer: 'Es muy sencillo, solo tienes que...' },
        { question: '¿Cuál es el precio?', answer: 'Ofrecemos diferentes planes...' }
      ];
    }
    this.editableStyles = { 
        ...this.config.styles,
  ...
  addItem() {
    this.editableItems.push({
      ...
      answer: 'Escribe la respuesta aquí...'
    });
