...
describe('EditorDesktopFeatureComponent', () => {
  let component: EditorDesktopFeatureComponent;
  let fixture: ComponentFixture<EditorDesktopFeatureComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [EditorDesktopFeatureComponent],
      providers: [
        ...
        { provide: VisualEditorService, useValue: { interactionMode: 'all', setInteractionMode: jest.fn(), isDragging: false, isResizing: false, elementMoved$: of(), elementResized$: of(), enableEditMode: jest.fn() } },
    ...
    fixture = TestBed.createComponent(EditorDesktopFeatureComponent);
