...
@Component({
      ...
      <div class="isolated-mode-container" (click)="$event.stopPropagation()">
        ...
        <div class="isolated-mode-header">
          <div class="header-breadcrumb">
            ...
            <span class="component-name">TABLA DE DATOS PRO</span>
          </div>
            ...
            <div class="sidebar-scroll-content">
              ...
              <div class="sidebar-section" *ngIf="activeTab === 'data'">
                ...
                <div class="column-list">
                  ...
                  <button (click)="addColumn()" class="add-btn-mini">+ Añadir Columna</button>
                </div>
                ...
                <button (click)="addRow()" class="add-btn-mini mt-4">+ Añadir Fila</button>
              </div>
              ...
              <div class="sidebar-section" *ngIf="activeTab === 'style'">
                ...
                <div class="control-group">
                  ...
                  <div class="toggle-wrapper" (click)="editableContent.dark = !editableContent.dark" [class.active]="editableContent.dark">
                    ...
                    <span>{{ editableContent.dark ? 'MODO OSCURO' : 'MODO CLARO' }}</span>
                  </div>
                </div>
                ...
                <div class="control-row grid grid-cols-2 gap-2">
                   <div class="control-group">
                      <label>X (PX)</label>
                      <input type="number" [(ngModel)]="currentPosition.x" class="premium-input">
                   </div>
                   <div class="control-group">
                      <label>Y (PX)</label>
                      <input type="number" [(ngModel)]="currentPosition.y" class="premium-input">
                   </div>
                </div>
              </div>
        ...
        <div class="isolated-mode-footer">
          ...
          <div class="footer-actions-btns">
            ...
            <button class="btn-clean primary" (click)="apply()">Aplicar a la Página</button>
          </div>
        </div>
      </div>
    </div>
  ...
  styles: [`
    ...
    .column-item { display: flex; gap: 6px; align-items: center; background: rgba(255,255,255,0.02); padding: 4px; border-radius: 8px; }
    ...
    .add-btn-mini { width: 100%; background: transparent; border: 1px dashed rgba(16, 185, 129, 0.4); color: #10b981; padding: 8px; border-radius: 8px; font-size: 10px; font-weight: 700; cursor: pointer; transition: all 0.2s; }
    ...
    .toggle-wrapper.active { border-color: #10b981; background: rgba(16, 185, 129, 0.1); }
    .toggle-track { width: 30px; height: 16px; background: #334155; border-radius: 20px; position: relative; transition: all 0.2s; }
    .toggle-wrapper.active .toggle-track { background: #10b981; }
    ...
    .draggable-wrapper { position: relative; cursor: move; border: 1.5px dashed #10b981; padding: 5px; background: rgba(255,255,255,0.05); }
...
export class EditorTableIsolatedModeComponent implements OnInit, OnDestroy {
