...
@Component({
      ...
      <div class="isolated-mode-container" (click)="$event.stopPropagation()">
        ...
        <div class="isolated-mode-header">
          <div class="header-breadcrumb">
            ...
            <span class="component-name">CENTRO DE ATENCION AL CLIENTE</span>
          </div>
        ...
        <div class="isolated-mode-body">
          <div class="controls-sidebar">
            <div class="sidebar-scroll-content">
              ...
              <div class="sidebar-tabs">
                <button [class.active]="activeTab === 'info'" (click)="activeTab = 'info'">DATOS</button>
                ...
                <div class="item-list">
                  <div *ngFor="let item of editableItems; let i = index" 
                    ...
                    <div class="item-main">
                      ...
                      <input type="text" [(ngModel)]="item.label" class="premium-input-mini" placeholder="Ej: Teléfono">
                    ...
                    <div *ngIf="selectedIndex === i" class="item-details animate-fade-in">
                       ...
                       <input type="text" [(ngModel)]="item.value" class="premium-input-mini" placeholder="+34 600...">
                       
                       <label class="mt-3">Icono (Emoji)</label>
                       <input type="text" [(ngModel)]="item.icon" class="premium-input-mini" placeholder="📞, 📧, 🗺️...">
                    </div>
                  </div>
                </div>

                <button (click)="addItem()" class="add-btn-mini mt-4">+ Añadir Método</button>

                <div class="divider-sidebar mt-8 mb-4"></div>

                <div class="control-group">
                   <label>Título del Formulario</label>
                   <input type="text" [(ngModel)]="editableContent.formTitle" class="premium-input" placeholder="Escríbenos">
                </div>
              </div>
              ...
              <div class="sidebar-section" *ngIf="activeTab === 'design'">
                ...
                <div class="control-group">
                  ...
                  <select [(ngModel)]="editableContent.variant" class="premium-input">
                    ...
                    <option value="centered">Centrado Minimal</option>
                    <option value="map-bg">Mapa de Fondo</option>
                ...
                <div class="control-group">
                   <label class="checkbox-label">
                      <input type="checkbox" [(ngModel)]="editableContent.showMap"> Incluir Mapa Interactivo
                   </label>
                </div>
              </div>
          ...
          <div class="isolated-canvas">
            ...
            <div class="modern-position-dock">
               <div class="dock-item"><span class="label">MÉTODOS</span><span class="value text-indigo-400">{{ editableItems.length }}</span></div>
               <div class="dock-divider"></div>
               <div class="dock-item"><span class="label">VARIANTE</span><span class="value text-blue-400 uppercase">{{ editableContent.variant }}</span></div>
            </div>
          </div>
        </div>

        <div class="isolated-mode-footer">
          <div class="footer-hint">Contact Pro: Facilita que tus clientes te encuentren con una interfaz intuitiva.</div>
  ...
  styles: [`
    ...
    .contact-item-card { background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 12px; cursor: pointer; transition: all 0.2s; }
    .contact-item-card:hover { border-color: rgba(255,255,255,0.1); background: rgba(255,255,255,0.05); }
    .contact-item-card.active { border-color: #10b981; background: rgba(16, 185, 129, 0.05); }
    ...
    .divider-sidebar { height: 1px; background: rgba(255,255,255,0.05); width: 100%; }
...
export class EditorContactIsolatedModeComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.editableItems = [...(this.config.content['contactItems'] || [])];
